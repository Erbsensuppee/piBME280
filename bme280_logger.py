...
while running:
    try:
        ...
        file_exists = os.path.isfile('/home/piData/Documents/piBME280/data/sensor_readings_bme280.txt')
        file = open('/home/piData/Documents/piBME280/data/sensor_readings_bme280.txt', 'a')
        ...
        desired_timezone = pytz.timezone('Europe/Vienna')  # Replace with your desired timezone
